    ...
    @foreach($currentQuizzes as $quiz)
        <div>
            ...
            <div >
                ...
                <div >
                    <a href="/edit-page/{{$quiz->id}}" >რედაქტირება</a>
        ...
        @foreach($currentQuestions as $question)
            <div>
                ...
                <div>
                    ...
                    <div >
                        <a href="/edit-question/{{$question->id}}">რედაქტირება</a>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style="display: flex; flex-direction: row;">
                            <a href="/edit-page/{{$quiz->id}}" class="btn me-2 btn-outline-dark">რედაქტირება</a>
                            <form action="/delete-quiz/{{$quiz->id}}" method="POST">
                                @csrf
                                <button type="submit">წაშლა</button>
                            </form>
